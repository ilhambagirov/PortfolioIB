...
{
    public class BlogtEditCommand : BlogViewModel, IRequest<int>
    {
        public class BlogEditCommandHandler : IRequestHandler<BlogtEditCommand, int>
        {
            ...
            public async Task<int> Handle(BlogtEditCommand request, CancellationToken cancellationToken)
            {
